    ...
    return (
        <div className="recent-order">
            ...
            <table className="table-container__table">
                ...
                <tbody>
                    {_closedTournamentPositions.map((_position, index) => (
                        <tr key={_position.coin.symbol}>
                            ...
                            >
                                {" "}
                                {_position.position.buyOrder ? "Long" : "Short"}
                            </td>

                            <th> {_position.position.quantity}</th>
                            <th> ${_position.position.entryPrice}</th>
                            <th> ${_position.position.closePrice}</th>
                            <td
                                style={
